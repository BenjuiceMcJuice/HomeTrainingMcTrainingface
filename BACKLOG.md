...
| BTL-B51 | Own goal pyramid on a phone — *Own 6c* on Plan › Goals, the New Goal sheet (tap Send ↔ Own and the counts should switch 4/4 · 2/2 · 1/1 ↔ 5/8 · 2/8 · 1/8) and the Dashboard rope widget; *owned* on the 6a+ row; *Pyramid complete* on both kinds, *Ready · Pyramid part-built* under the grade picker, no *base* anywhere but the header; check on the live site once BTL-B52/B53 are merged | Check | **Ben** | Ready | BTL-B53 |
