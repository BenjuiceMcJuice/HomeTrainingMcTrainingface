...
| BTL-B40 | The analysis reserves 1,400 completion tokens, so three fit in Groq's 8,000/min; `reasoning_effort: 'low'` on gpt-oss might let the reservation drop, but needs a real key to try | Check | **Ben** | Ready | — |
