...
| BTL-B57 | Own forecast on a phone — the rope card and Plan › Goals *Own 6c*: the headline should read a date that moves nearer with each 6c send, never later; the steps line *…from your 1 in N days, steadied by assuming 6c comes about half as often as the rows below*; check on the preview deploy | Check | **Ben** | Ready | — |
