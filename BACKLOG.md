...
| BTL-B51 | Own goal pyramid on a phone — *Own 6c* on Plan › Goals, the New Goal sheet (tap Send ↔ Own and the counts should switch 4/4 · 2/2 · 1/1 ↔ 5/8 · 2/8 · 1/8) and the Dashboard rope widget; *owned* on the 6a+ row; check on the live site once BTL-B52 is merged | Check | **Ben** | Ready | BTL-B52 |
