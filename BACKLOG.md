...
| BTL-B51 | Own goal pyramid on a phone — *Own 6c* on Plan › Goals, the New Goal sheet (tap Send ↔ Own and the 6c row should redraw 1/1 ↔ 1/8) and the Dashboard rope widget; *owned* on the 6a+ row; the forecast reading *mid-October … 7 weeks inside your deadline* with five dots; check on the live site | Check | **Ben** | Ready | — |
