...
interface Session {
  ...
  type:        "gym" | "climb" | "hangboard" | "cardio"
...
| Field | `gym` | `climb` | `hangboard` | `cardio` | Notes |
|---|---|---|---|---|---|
| `id` | uuid | uuid | uuid | uuid | auto-generated by `useSessions` |
| `date` | YYYY-MM-DD | YYYY-MM-DD | YYYY-MM-DD | YYYY-MM-DD | user-editable via date picker |
| `type` | `"gym"` | `"climb"` | `"hangboard"` | `"cardio"` | immutable after creation |
...
| `createdAt` | ISO datetime | ISO datetime | ISO datetime | ISO datetime | set once by `useSessions.addSession` |
| `updatedAt` | ISO datetime | ISO datetime | ISO datetime | ISO datetime | bumped by `useSessions.updateSession` |
