...
| Real external users (non-Ben) | 2–3 |
| Active in last 30 days | 3 (Ben, Dave, Another tester) |
...
|---|---|---|---|---|---|---|
| **Benjuice** (gWT9Fv74n…) | 40 | 2026-05-28 | gym×33, climb×4, hang×2, cardio×1 | 14 | 3 | **Ben's main account** |
...
| bentest (B8tWPfqI…) | 7 | 2026-03-28 | climb×4, hang×2, gym×1 | 2 | 0 | Ben's test account |
| Tester mc tester (Xggr8toX…) | 4 | 2026-03-28 | climb×3, gym×1 | 1 | 0 | Ben's test account |
| Benjuice (btcJmyzk…) | 15 | 2026-03-27 | climb×10, gym×4, hang×1 | 2 | 0 | Ben's old account (pre-current) |
| (no name) (q5bHKM2G…) | 1 | 2026-03-28 | climb×1 | 0 | 0 | Single session, test era |
| Ben Gmail (vfipIiWI…) | 2 | 2026-03-07 | climb×2 | 1 | 0 | Ben's Gmail test account |
...
### Feature adoption (all users, excl. Ben)
...
- AI coach untested by anyone other than Ben (requires Groq key setup)

### Ben's main account (gWT9Fv74n…)
...
- [ ] Nobody outside Ben has tried gym, hangboard, goals, or AI coach — these are undiscovered features for real users
