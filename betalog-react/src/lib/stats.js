...
var MET_SWIM = {
  breaststroke: { 1: 5.3, 2: 6.0, 3: 7.0 },
  front_crawl:  { 1: 5.8, 2: 7.0, 3: 9.8 },
  backstroke:   { 1: 4.8, 2: 6.0, 3: 8.0 },
  butterfly:    { 1: 8.0, 2: 10.5, 3: 13.8 },
  general:      { 1: 5.0, 2: 6.0, 3: 8.0 },
}

var MET_CARDIO = {
  swim:  { 1: 5.0, 2: 6.0, 3: 8.0 },
